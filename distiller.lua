...
function get_distiller_recipe(metal1, metal2)
	...
	if distiller_recipes[metal2.name..metal1.name]
...
technic.register_machine("LV", "chemistry:distiller","RE")
technic.register_machine("LV", "chemistry:distiller_active","RE")
